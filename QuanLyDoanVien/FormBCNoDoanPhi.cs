...
{
    public partial class FormBCNoDoanPhi : Form
    {
        public FormBCNoDoanPhi()
        {
            InitializeComponent();
        }

        private void FormBCNoDoanPhi_Load(object sender, EventArgs e)
        {
            try
            {
                this.v_SVNoDoanPhiTableAdapter.Fill(this.QLDV.v_SVNoDoanPhi);
            }catch(Exception ex)
            {
