...
{
    public partial class FormBCTongThuChi : Form
    {
        public FormBCTongThuChi()
        {
            InitializeComponent();
        }

        private void FormBCTongThuChi_Load(object sender, EventArgs e)
        {
            try
            {
                this.v_TongThuChiTableAdapter.Fill(this.QLDV.v_TongThuChi);
            }catch(Exception ex)
            {
